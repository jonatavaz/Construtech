...
class _PersonPageState extends State<PersonPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      _controller = Provider.of<PersonController>(context, listen: false);
      _controller.addListener(_onControllerStateChange);
      _controller.fetchFornecedores(context);
    });
  }
              ...
              children: [
                ...
                Consumer<PersonController>(
                  builder: (context, controller, child) {
                      ...
                      return Expanded(
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final color =
                                (fornecedor.avaliacao == 'Excelente' ||
                                    fornecedor.avaliacao == 'Bom')
                                ? Colors.green
                                : Colors.red;
                            return ListTile(
                    ...
                    return const Expanded(
                      child: Center(
                        child: Text('Iniciando busca de fornecedores...'),
                      ),
                    );
                  },
                ),
